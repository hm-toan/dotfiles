...
# nvm PATH is resolved via the fast path in .zshenv; run `load-nvm` when you
# need nvm commands (nvm use, nvm install, etc). Eager sourcing here cost
# ~250-400ms per shell start (verified with zprof).
